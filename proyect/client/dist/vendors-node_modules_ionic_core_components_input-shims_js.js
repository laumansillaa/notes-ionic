"use strict";
(self["webpackChunkproyect"] = self["webpackChunkproyect"] || []).push([["vendors-node_modules_ionic_core_components_input-shims_js"],{
...
const jsSetFocus = async (componentEl, inputEl, contentEl, footerEl, keyboardHeight) => {
  ...
  if (typeof window !== 'undefined') {
    ...
    const scrollContent = async () => {
      ...
      if (contentEl) {
        await (0,_index8_js__WEBPACK_IMPORTED_MODULE_1__.b)(contentEl, 0, scrollData.scrollAmount, scrollData.scrollDuration);
      }
...
//# sourceMappingURL=vendors-node_modules_ionic_core_components_input-shims_js.js.map